...
namespace RetoN
{
    ...
    public class ToDoActivity : Activity
    {
        ...
        // Make sure the GCM client is set up correctly. GcmClient.CheckDevice(this); GcmClient.CheckManifest(this);

        // Register the app for push notifications. GcmClient.Register(this, ToDoBroadcastReceiver.senderIDs);
        ...
        string emailRegistro = "max_210291@hotmail.com"; // Ingresa tu email
        string codigoReto = "RetoN + f8d2f "; // El codigo de reto para esta actividad es "registro"
